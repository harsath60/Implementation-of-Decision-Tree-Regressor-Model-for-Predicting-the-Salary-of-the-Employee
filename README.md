...
5. Predict salaries using the test data and evaluate the model using MAE, MSE, RMSE, and R² sco
...
```
## Output:
<img width="1441" height="869" alt="image" src="https://github.com/user-attachments/assets/294468e5-d0ea-4b5d-bf11-80cb5f13ac98" />
